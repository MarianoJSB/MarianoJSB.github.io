...
let numerosUsados = []
let palabras = [
    'dog', 'cat', 'lion', 'elephant', 'giraffe', 'monkey', 'bear', 'fox', 'wolf', 'rabbit', 'bird', 'fish', 'turtle', 'crocodile', 'penguin', 'zebra', 'horse', 'cow', 'pig', 'tiger', 'panda', 'koala', 'kangaroo', 'dolphin', 'whale', 'octopus', 'squid', 'camel', 'llama', 'eagle', 'falcon', 'owl', 'snake', 'lizard', 'frog', 'toad', 'butterfly', 'bee', 'ant'
];
