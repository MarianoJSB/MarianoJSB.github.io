...
let palabras = [
    ...
    'letter k', 'letter l', 'letter m', 'letter n', 'letter ñ', 'letter o', 'letter p', 'letter q', 'letter r', 'letter s',
    'letter t', 'letter u', 'letter v', 'letter w', 'letter x', 'letter y', 'letter z', 'number 0', 'number 1', 'number 2',
    'number 3', 'number 4', 'number 5', 'number 6', 'number 7', 'number 8', 'number 9', 'giraffe', 'dog', 'cat',
    'elephant', 'lion', 'tiger', 'bear', 'zebra', 'kangaroo', 'hippopotamus', 'rhinoceros', 'monkey', 'snake',
    'crocodile', 'whale', 'dolphin', 'shark', 'penguin', 'eagle', 'owl', 'chicken', 'horse', 'cow',
    'pig', 'sheep', 'goat', 'rabbit', 'mouse', 'bat', 'carrot', 'broccoli', 'spinach', 'zucchini',
    'tomato', 'cucumber', 'bell pepper', 'corn', 'peas', 'pumpkin', 'apple', 'banana', 'strawberry', 'orange',
    'grape', 'watermelon', 'pineapple', 'melon', 'pear', 'mango', 'mom', 'dad', 'grandma', 'grandpa', 'house', 'car',
    'sun', 'moon', 'tree', 'flower', 'ball', 'toy', 'book', 'water', 'milk', 'bread', 'hand', 'foot'
  ];
